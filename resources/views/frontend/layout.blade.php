  ...
  <body>
    ...
    <div class="super_container">
      ...
      <header class="header">
        ...
        >
          <div class="logo"><h1 href="{{ route('homepage') }}">DAShop</h1></div>
          <nav class="main_nav">
...
{{--  --}}
      ...
      >
        ...
        <div class="logo menu_mm"><a href="{{ route('homepage') }}">DAShop</a></div>
        <nav class="menu_nav">
          <ul class="menu_mm">
            <li><a href="{{ route('homepage') }}">home</a></li>
          ...
          <div class="row">
            <div class="col text-center">
              ...
              <div class="copyright">
                ...
                All rights reserved | Toko DAShop
              </div>
            </div>
          </div>
        </div>
