...
<div class="home">
          ...
          <div class="owl-carousel owl-theme home_slider">
            ...
            <div class="owl-item">
              <div
                ...
                style="background-image: url({{ asset('frontend/images/home3.jpg') }})"
              ></div>
              <div class="home_slider_content">
                <div class="home_slider_content_inner">
                <div class="home_slider_subtitle">Produk Premium</div>
                  <div class="home_slider_title">Ready Stok</div>
                </div>
              </div>
            </div>
            ...
            <div class="owl-item">
              <div
                class="home_slider_background"
                style="background-image: url({{ asset('frontend/images/home4.jpg') }})"
              ></div>
              <div class="home_slider_content">
                <div class="home_slider_content_inner">
                  <div class="home_slider_subtitle">Produk Premium</div>
 ...
 <div class="owl-item">
    <div
      class="home_slider_background"
      style="background-image: url({{ asset('frontend/images/home5.jpg') }})"
    ></div>
    <div class="home_slider_content">
      <div class="home_slider_content_inner">
        <div class="home_slider_subtitle">Prodak Premium</div>
        <div class="home_slider_title">Ready Stok</div>
      </div>
    </div>
  </div>
